...
|landscape| No errors | <details><summary>Screenshot of result</summary>![Result](documentation/validator/landscape1.png) ![Result](documentation/validator/landscape2.png)</details>| :white_check_mark:|
|marco| No errors | <details><summary>Screenshot of result</summary>![Result](documentation/validator/macro1.png) ![Result](documentation/validator/macro2.png)</details>| :white_check_mark:|
...
|portrait| No errors | <details><summary>Screenshot of result</summary>![Result](documentation/validator/portrait1.png) ![Result](documentation/validator/portrait2.png)</details>| :white_check_mark:|
